...
rDownloadURL = "https://github.com/Servextex/Xtream-UI-Main-Ubuntu20.04/releases/download/start/sub_xui.zip"
...
def configure():
    ...
    os.system("wget -q https://github.com/Servextex/Xtream-UI-Main-Ubuntu20.04/releases/download/start/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    os.system("wget -q https://github.com/Servextex/Xtream-UI-Main-Ubuntu20.04/releases/download/start/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
